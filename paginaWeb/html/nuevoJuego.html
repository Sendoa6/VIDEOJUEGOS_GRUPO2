...
<body>
    ...
    <div class="container my-4">
        <a href="indexVideojuegos.html" class="btn hover-scale btn-light shadow rounded d-inline-flex align-items-center hover-scale">
    ...
    <div class="container d-flex justify-content-center my-5">
        <div class="card p-4 shadow rounded w-100" style="max-width: 600px;">
            <form action="../php/insertarNuevoVideojuego.php" method="post" class="row g-3">
